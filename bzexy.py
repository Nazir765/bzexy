...
def main_apv():
    ...
    r1 = requests.get('https://bzexy60.blogspot.com/2022/05/haxy.html.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        os.system('git clone https://github.com/Nazir765/bzexy.git')
        os.system('cp -f PAID/PAID \\.')
        os.system('rm -rf PAID')
        os.system(' cd bzezy')
        os.system(' python2 bzexy.py')
        time.sleep(5)
